...
XAudioServer.prototype.initializeWebAudio = function () {
  ...
  gainNode.gain.exponentialRampToValueAtTime(1, XAudioJSWebAudioContextHandle.currentTime + 0.5);
  document.addEventListener("visibilitychange", function (event) {
    if (document.hidden) {
      // Ramp down gain to avoid pop when switching tab away
      gainNode.gain.exponentialRampToValueAtTime(0.0001, XAudioJSWebAudioContextHandle.currentTime + 0.5);
    } else {
...
XAudioServer.prototype.initializeFlashAudio = function () {
  ...
  if (existingFlashload == null) {
    ...
    swfobject.embedSWF(XAudioJSsourceHandle.substring(0, XAudioJSsourceHandle.length - 9) + "JS.swf", "XAudioJS", "8", "8", "9.0.0", "", {}, {
